export default function HeavensFangAvatar({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <div className={`${className} rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center relative overflow-hidden`}>
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <circle cx="43" cy="39" r="1.5" fill="#60a5fa" opacity="0.9" />
        <circle cx="57" cy="39" r="1.5" fill="#60a5fa" opacity="0.9" />
        
        {/* Third eye symbol on forehead */}
        <circle cx="50" cy="32" r="2" fill="none" stroke="#2563eb" strokeWidth="1" opacity="0.7" />
        <circle cx="50" cy="32" r="1" fill="#60a5fa" opacity="0.6" />
        ...
        {/* Mystical aura lines */}
        <path d="M20 30 L25 32" stroke="#60a5fa" strokeWidth="1" opacity="0.4" />
        <path d="M80 30 L75 32" stroke="#60a5fa" strokeWidth="1" opacity="0.4" />
        <path d="M25 70 L30 68" stroke="#60a5fa" strokeWidth="1" opacity="0.4" />
        <path d="M75 70 L70 68" stroke="#60a5fa" strokeWidth="1" opacity="0.4" />
